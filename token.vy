...
def __init__(_name: String[32], _symbol: String[32], _decimals: uint8, _supply: uint256):
    init_supply: uint256 = 21_000_000_000 * 10 ** 6  # Set total supply to 21 billion tokens with 6 decimal places
    self.name = _name
    self.symbol = _symbol
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    """
    assert _value <= 21_000_000 

    # Check the receiver's balance after the transfer
    assert self.balanceOf[_to] + _value <= 21_000_000  
